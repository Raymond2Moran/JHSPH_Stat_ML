...
plot(hc_complete)
```
To test for whether or not the result depends on linkage types, we do:
...
We observed different results, thus it does depend on the  type of linkage selected.

### (c) 

To give a best representation of which genes differ the most, we calculate the absolute mean value difference:
