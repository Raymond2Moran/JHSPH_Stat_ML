...
<mark> From the integrated result summary table, we can observe that variables `rad` and `tax` have the most significant effect on the response variable, criminal rate per Capita.
